...
class IPM : public rclcpp::Node
{
  ...
  private:
                     ...
                     sensor_msgs::msg::CameraInfo &camera_info)
    {
        ...
        // copying to device
        cudaMemcpy(d_caminfo, inv_caminfo, sizeof(double) * 9,
                   cudaMemcpyHostToDevice);
        cudaMemcpy(d_uv_hom, uv_hom.data(), sizeof(double) * 3 * rows,
                   cudaMemcpyHostToDevice);
        ...
        cudaMemcpy(kin_uv.data(), d_kin_uv, sizeof(double) * 3 * rows,
                   cudaMemcpyDeviceToHost);
        cudaMemcpy(denom.data(), d_denom, sizeof(double) * rows,
                   cudaMemcpyDeviceToHost);
